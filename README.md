...
| [`/plans/chiiki-fukushi-3shi/`](plans/chiiki-fukushi-3shi/) | **長崎県の離島3市の地域福祉計画 ― 壱岐・五島・対馬を並べて読む** — 第4次で決めることになる5つの論点（圏域・包括的支援体制の型・指標・社協との関係・点検の場）で、同じ県の離島2市の現行計画を計画本体から並べる。指標は0本／56本／社協のみ21本、点検の約束は4年目に1回／なし／毎年度。照合記録は [`docs/chiiki-fukushi/`](docs/chiiki-fukushi/) |
